...
add_action( 'wp_enqueue_script', 'bikcraft_scripts' );

function bikcraft_css() {
	wp_register_style('bikcraft_style', get_stylesheet_directory_uri() . 'style.css', [], false, false);

	wp_enqueue_style('bikcraft_style');
}
add_action( 'wp_enqueue_style', 'bikcraft_css' );

// Remover Código Wp inútil
